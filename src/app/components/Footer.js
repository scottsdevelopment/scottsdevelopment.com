...
export default function Footer() {
  ...
  return (
    <footer id="contact" className={`mt-12 border-t ${colors.border.primary} ${colors.bg.secondary40}`}>
      <div className="mx-auto max-w-7xl px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <ul className={`mt-3 ${colors.text.secondary} text-sm space-y-2`}>
            <li><a href="#services" className={`${colors.link.default} ${colors.link.hover}`}>Enterprise Solutions</a></li>
            <li><a href="#services" className={`${colors.link.default} ${colors.link.hover}`}>Legacy System Modernization</a></li>
            <li><a href="#services" className={`${colors.link.default} ${colors.link.hover}`}>App Development & Compliance</a></li>
            <li><a href="#services" className={`${colors.link.default} ${colors.link.hover}`}>AI & Automation Integration</a></li>
          </ul>
        </div>
          ...
          <div className={`mt-3 ${colors.text.secondary} text-sm space-y-2`}>
            <div>
              <a 
                ...
                className={`${colors.link.default} ${colors.link.hover} ${colors.link.underline}`}
              >
      ...
      <div className={`border-t ${colors.border.primary60} py-4 text-center ${colors.text.secondary} text-xs`}>
